...
*
* */
package com.inertialelements.cube;
...
import com.inertialelements.rxtx.Constants;
...
//        textures[0].enable(gl);
    ...
    public void setQuaternionData(float[] quaternionData) {
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        // BEGIN - Added by GT Silicon - BEGIN //
        Quaternion quaternion = new Quaternion(quaternionData[1], quaternionData[3], -quaternionData[2], quaternionData[0]);
